...
assets/
  ...
  js/line-v4.js          La ligne continue de l'accueil : construit le tracé SVG
...
2. **Cache** : la feuille et le script communs sont mis en cache un mois. Si vous les modifiez après la mise en ligne, renommez le fichier (ils s'appellent aujourd'hui `main-v9.css`, `main-v3.js` et `line-v4.js`, passez au numero suivant) et mettez à jour les références dans toutes les pages HTML.
